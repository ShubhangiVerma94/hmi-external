import { ShubhangiComponent } from './components/Shubhangi--external/Shubhangi--external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, ShubhangiComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, ShubhangiComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
